...
static void process_frequency_lines(u32 inPtr, u32 t5, u32 t6)
{
    ...
    *(s16*)(mp3data+((t6 + 0x080))) = (s16)(t[5] - t[6]);
    *(s16*)(mp3data+((t6 + 0x0c0))) = (s16)(t[13] - t[10]);
    ...
    *(s16*)(mp3data+((t5 + 0x080))) = (s16)(v[4] - t[6]);
    *(s16*)(mp3data+((t5 + 0x0c0))) = (s16)(t[12] - t[10] - v[8]);
    *(s16*)(mp3data+((t5 + 0x100))) = (s16)(-v[2]);
    *(s16*)(mp3data+((t5 + 0x140))) = (s16)(v[8] - t[12]);
