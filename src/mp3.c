...
static void process_frequency_lines(u32 inPtr, u32 t5, u32 t6)
{
    ...
    *(s16*)(mp3data+((t5 + 0x200))) = (s16)(-v[16]);
    ...
    v[0] =  (v[16] + v[17]) >> 1;
    v[1] = ((v[16] - v[17]) * K[0]) >> 0x10;
    v[2] = -(v[18] + v[19]);
    v[3] = ((v[18] - v[19]) * K[1]) >> 0x10;
    v[4] = v[20] + v[21] + v[0];
    v[5] = (((v[20] - v[21]) * K[1]) >> 0x10) + v[1];
    v[6] = (((v[22] + v[23]) << 1) + v[0]) - v[2];
    v[7] = (((v[22] - v[23]) * K[2]) >> 0x10) + v[0] + v[1] + v[3];
    *(s16 *)(mp3data+((t5 + 0x1e0))) = (s16)-v[0];
    v[8] = v[24] + v[25];
    v[9] = ((v[24] - v[25]) * K[1]) >> 0x10;
    v[10] = ((v[26] + v[27]) << 1) + v[8];
    v[11] = (((v[26] - v[27]) * K[2]) >> 0x10) + v[8] + v[9];
    v[12] = v[4] - ((v[28] + v[29]) << 1);
    *(s16 *)(mp3data+((t5 + 0x120))) = (s16)v[12];
    v[13] = (((v[28] - v[29]) * K[2]) >> 0x10) - v[12] - v[5];
    v[14] = v[6] - ((v[30] + v[31]) << 2);
    v[15] = (((v[30] - v[31]) * K[3]) >> 0x10) - v[7];
