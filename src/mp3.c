...
static void process_frequency_lines(u32 inPtr, u32 t5, u32 t6)
{
    ...
    *(s16*)(mp3data+((t6 + 0x040))) = (s16)(v[25] + v[14]);
    *(s16*)(mp3data+((t6 + 0x080))) = (s16)( v[5] - v[6]);
    *(s16*)(mp3data+((t6 + 0x0c0))) = (s16)(v[13] - v[10]);
    *(s16*)(mp3data+((t6 + 0x100))) = (s16)(v[19] - v[18]);
    *(s16*)(mp3data+((t6 + 0x140))) = (s16)(v[27] - v[13]);
    *(s16*)(mp3data+((t6 + 0x180))) = (s16)(v[23] - v[5]);
    ...
    *(s16 *)(mp3data+((t5 + 0x020))) = (s16)v[14];
    *(s16 *)(mp3data+((t5 + 0x060))) = (s16)(v[10] - v[6]);
    *(s16 *)(mp3data+((t5 + 0x0a0))) = (s16)(v[4] - v[10] + v[18]);
    *(s16 *)(mp3data+((t5 + 0x0e0))) = (s16)(-v[12] - v[18]);
    *(s16 *)(mp3data+((t5 + 0x120))) = (s16)v[12];
    *(s16 *)(mp3data+((t5 + 0x160))) = (s16)(v[24] - v[4]);
    *(s16 *)(mp3data+((t5 + 0x1a0))) = (s16)(v[0] - v[24]);
    *(s16 *)(mp3data+((t5 + 0x1e0))) = (s16)(-v[0]);
    
    *(s16 *)(mp3data+((t6 + 0x020))) = (s16)(v[14] + v[17]);
    *(s16 *)(mp3data+((t6 + 0x060))) = (s16)(v[9] - v[17] - v[6]);
    *(s16 *)(mp3data+((t6 + 0x0a0))) = (s16)(v[5] + v[18] - v[9]);
    *(s16 *)(mp3data+((t6 + 0x0e0))) = (s16)(v[13] - v[18]);
    *(s16 *)(mp3data+((t6 + 0x120))) = (s16)(v[19] - v[13]);
    *(s16 *)(mp3data+((t6 + 0x160))) = (s16)(v[11] - v[19] - v[5]);
    *(s16 *)(mp3data+((t6 + 0x1a0))) = (s16)(v[7] - v[11]);
